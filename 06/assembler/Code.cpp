...
string Code::dest(string destMnemonics){
    return destTable[destMnemonics];
}
string Code::comp(string compMnemonics){
    return compTable[compMnemonics];
}
string Code::jump(string jumpMnemonics){
    return jumpTable[jumpMnemonics];
}
